...
{
    public class EditAsAdminFunction
    {
        ...
        {
            var actual = await _controller.EditAsAdmin(null);
            ...
            Should_Return_BadRequest_When_ModelState_NotValid()
        {
            ...
            var actual =
                await _controller.EditAsAdmin(Moq.It.IsAny<ViewModels.Users.CreateViewModel>());
            ...
            Should_Return_ConflictObject_When_Username_Exists()
        {
            ...
            var actual =
                await _controller.EditAsAdmin(new Moq.Mock<ViewModels.Users.CreateViewModel>().Object);
